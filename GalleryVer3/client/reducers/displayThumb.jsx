...
export const thumbnailReducer = (state = { display_thumb_status : 'HIDE', images: img },  action) => {
    ...
    switch(action.type){
    	case 'SHOW_CAROUSEL':
    		...
    		return { display_thumb_status : 'HIDE', images: img }; 

    	

        case 'SHOW_THUMBNAIL':
            
            return { display_thumb_status : 'SHOW', images: img }; 
